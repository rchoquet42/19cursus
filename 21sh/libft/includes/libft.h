...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/13 12:44:00 by rchoquet          #+#    #+#             */
/*   Updated: 2018/12/17 15:43:41 by rchoquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_strcmp_char(const char *str1, const char *str2, char c);
char				*ft_strjoin_and_free1(char *s1, const char *s2);
...
size_t				ft_wcslcat(wchar_t *s1, const wchar_t *s2, size_t n);
wchar_t				*ft_wcsjoin(wchar_t const *s1, wchar_t const *s2);
wchar_t				*ft_wcsncpy(wchar_t *dst, const wchar_t *src, size_t len);
wchar_t				*ft_wcssub(wchar_t const *s, unsigned int st, size_t len);
